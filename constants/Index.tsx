...
export const elementAdmin : SpaceAdminShema[] = [
    ...
    {name : 'Customer', image : '/la-personne(1).png', link: 'customer'},
    {name : 'Order', image : '/commande(1).png', link: 'order'},
    {name : 'Stock', image : '/graphique.png', link: 'stock'},
    {name : 'Supplier', image : '/la-personne(1).png', link: 'supplier'},
    {name : 'orderOnline', image : '/commande-en ligne.png', link: 'orderonline'},
    {name : 'Setting', image : '/parametres-curseurs.png', link: 'setting'}
]

export const PagesLink : {id : number, link: string}[] = [
    { id: 0, link: 'Design' },
    { id: 1, link: 'Company' },
    { id: 2, link: 'Accessories' },
    { id: 3, link: 'Contact' },
]

export const Trending : { name: string, image: string, WIDTH:number, HEIGHT:number, price:number, newPrice?: number, desc: string} []= [
