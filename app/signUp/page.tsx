    ...
    <div className='flex h-screen items-center justify-center flex-col '>
        ...
        <div className='my-2 flex  border-2 rounded-xl hover:outline-none'>
          ...
          <div className='flex items-center'>
            <Image width={60} height={2} src='/64.png' alt='' className=' px-3 w-12 h-7'/>
            <h2 className=' relative right-[.2rem]  min-[326px]:right-1'>(+225)</h2>
          </div>
        ...
        <button className='bg-zinc-900 md:w-80 md:px-24 sm:px-24 px-[8.2rem] py-3 text-white rounded-xl min-[326px]:px-[6.3rem]'>Register</button>

        <div>
            <p className='my-3 text-gray-500'>Already Have An Account?  <Link href='/account' className=' text-black text-[15px] font-bold'>Login</Link></p>
        </div>
    </div>
  )
}
